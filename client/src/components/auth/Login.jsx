...
import {
    ...
    FaKey, FaUser, FaArrowRight, FaLock
} from 'react-icons/fa';
            ...
            <div className="auth-card">
                ...
                <div className="auth-header">
                    <div className="auth-icon">
                        {role === 'admin'
                            ? <FaUserShield size={44} color="#7c3aed" />
                            : <FaGraduationCap size={44} color="#4f46e5" />
                        }
                    </div>
                    <h1>{role === 'admin' ? 'Admin Login' : 'Student Login'}</h1>
                    <p>{role === 'admin' ? 'Access the administration panel' : 'Log in to your EI Tracker'}</p>
                </div>
